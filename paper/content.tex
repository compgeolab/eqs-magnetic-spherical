...
Moreover, blabla bla crv, curva L, generalize crv, 
Airborne magnetic data are characterized by strong spatial autocorrelation, 
with high data density along flight lines and large, un-sampled areas between them.
This structure violates the assumption of data independence required by conventional
random cross-validation.
If used, random validation would lead to overly optimistic error estimates, 
as the model would be tested on points geographically close to the training data, 
failing to assess its true generalization capability 
\citep{Roberts2017, Soler2021, Uppal2025}.
