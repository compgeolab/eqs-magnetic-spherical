...
Figure~\ref{fig_real_sources} presents the spatial distribution of the
equivalent sources and their contribution to the predicted field. The
shallow layer mainly captures short-wavelength anomalies associated
with near-surface geological features, while the deeper layer accounts
for long-wavelength components related to deeper crustal structures.

\begin{figure}[htb]
\centering
\includegraphics[width=1\linewidth]{figures/points-TFA-deep-shallow.jpeg}
\caption{Spatial distribution of the equivalent sources and their
contributions to the predicted total-field anomaly. The shallow layer
primarily represents short-wavelength features, whereas the deeper
layer captures long-wavelength components associated with deeper
geological structures.}
\label{fig_real_sources}
\end{figure}
