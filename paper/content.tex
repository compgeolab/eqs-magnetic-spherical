...
Most importantly, as shown in the synthetic data results, the
accurate recovery of the magnetic field components from the total-field
anomaly demonstrates the effectiveness and physical consistency of the
proposed inversion framework.
...
inversion workflows. As demonstrated by \citet{HidalgoGato2021} the use of
vector-derived quantities, such as the amplitude of the magnetic anomaly,
provides robust constraints on source geometry and depth while being only
weakly dependent on the magnetization direction. This characteristic
...
proposed framework offers a solid foundation for subsequent structural
...
short- long-wavelength of the magnetic field and maintaining manageable computational
requirements.
Future developments will include a systematic evaluation of distortions introduced
by Cartesian formulations in comparison with the spherical framework, the
adaptation of the spherical dual-layer equivalent sources methodology to gravimetric
data, and the extension of Euler deconvolution techniques to spherical
coordinates for improved source geometry interpretation. These advances will
further enhance the applicability of the framework to complex geological
