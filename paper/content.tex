...
\citep{Alldredge1969, Mayhew1979, Alldredge1969,Mayhew1980, Reilly1978, Mayhew1982}.
...
incorporate the correction proposed by \citet{Dyment1998} During our implementation, we verified that
...
\begin{equation}
    \hat{\mathbf{m}} = \mathbf{S}^{-1}\hat{\mathbf{c}}.
\end{equation}
...
\begin{equation}
    \vec{\mathbf{B}}({r, \theta, \lambda}) = \sum_{j=1}^{M} \vec{\mathbf{b}_{j}}({r, \theta, \lambda}) \, \hat{m}_j.
\end{equation}
...
\caption{Flowchart of the dual-layer equivalent sources method,
illustrating the data decimation, deep source fitting, residual
calculation, and final grid prediction \citep{Uppal2025}.}
...
Geological Survey of Brazil (SBG) through the REATE platform at
\url{https://reate.cprm.gov.br/anp/TERRESTRE}.
...
We are grateful to Santiago R. Soler, Yago M. Castro, and Gelson F.
Souza-Junior for discussions that helped shape and refine this research.
