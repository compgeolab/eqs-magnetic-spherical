...
components, together with the total-field norm.

\begin{figure}[htb]
\centering
\includegraphics[width=1\linewidth]{figures/real-data-tfa-norm-bcomponents.jpeg}
\caption{Predicted magnetic field components and total-field norm.
...
The norm of the predicted magnetic field highlights zones of enhanced magnetic
...
suited
for regional to continental-scale applications.


%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Conclusions}

In this work, we developed and validated a spherical equivalent source
...
recent advances in windowed inversion and multi-depth source
decomposition to a spherical methods, the proposed methodology
...
further improved the reliability of the forward modeling. These
developments provide a robust foundation for accurate vector-field
reconstruction on regional to continental scales.
...
source method provides an efficient and geometrically consistent
solution for regional and continental magnetic field modeling. It
enables scalable interpolation, continuation, and vector-field recovery
from heterogeneous airborne surveys, overcoming key limitations of
previous Cartesian and global inversion approaches.
