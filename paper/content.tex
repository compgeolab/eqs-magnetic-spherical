...
Matplotlib \citep{Hunter2007} and PyGMT \citep{PyGMT} for visualization and map
generation, Pandas \citep{Pandas} for tabular data handling,
Xarray \citep{Hoyer2017} for working with gridded datasets,
Verde \citep{Uieda2018} for spatial interpolation and moving-window analysis, and
