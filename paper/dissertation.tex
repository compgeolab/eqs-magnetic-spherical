...
áreas geográficas.
Para aprimorar a representação de fontes magnéticas, é
adotada uma configuração em duas camadas para separar componentes de
comprimentos de onda longos e curtos. A validação cruzada é utilizada
para determinar os hiperparâmetros ótimos de cada camada, garantindo
inversões estáveis e equilibradas. Para assegurar viabilidade
...
melhorando significativamente o desempenho computacional. O método é
avaliado por meio de conjuntos de dados sintéticos e reais, com ênfase em
cobertura espacial em larga escala, distribuições multiescala de fontes e
robustez a variações na densidade de amostragem. A implementação final é
disponibilizada como software de código aberto, visando apoiar a
reprodutibilidade e ampliar sua adoção.
